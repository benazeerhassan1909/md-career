...
function Synchronizer(props) {
    ...
    $[30] !== incomingValue || $[31] !== syncActorRef ? (t13 = ()=>{
        ...
        syncActorRef,
        incomingValue
    ], $[30] = incomingValue, $[31] = syncActorRef, $[32] = t13, $[33] = t14) : (t13 = $[32], t14 = $[33]), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(t13, t14);
    let t15;
...
const insertTextActionImplementation = ({ action })=>{
    action.editor.marks ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].insertNodes(action.editor, {
        text: action.text,
        ...action.editor.marks
    }) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].insertText(action.editor, action.text), action.editor.marks = null;
};
...
const addAnnotationActionImplementation = ({ context, action })=>{
    const parsedAnnotation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$parse$2d$blocks$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseAnnotation"])({
        annotation: {
    ...
    if (!parsedAnnotation) throw new Error(`Failed to parse annotation ${JSON.stringify(action.annotation)}`);
...
const decoratorAddActionImplementation = ({ context, action })=>{
    const editor = action.editor, mark = action.decorator, value = fromSlateValue(editor.children, context.schema.block.name, KEY_TO_VALUE_ELEMENT.get(editor)), manualAnchor = action.at?.anchor ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$util$2e$slice$2d$blocks$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["blockOffsetToSpanSelectionPoint"])({
        value,
        blockOffset: action.at.anchor,
        direction: "backward"
    }) : void 0, manualFocus = action.at?.focus ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$util$2e$slice$2d$blocks$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["blockOffsetToSpanSelectionPoint"])({
        value,
    ...
    if (!range) throw new Error(`Failed to get Slate Range for selection ${JSON.stringify(action.at)}`);
    ...
    const parsedInlineObject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$parse$2d$blocks$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseInlineObject"])({
        context,
        inlineObject: {
    ...
    if (!parsedInlineObject) throw new Error(`Failed to parse inline object ${JSON.stringify(action.inlineObject)}`);
...
const moveBackwardActionImplementation = ({ action })=>{
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].move(action.editor, {
        unit: "character",
...
}, moveForwardActionImplementation = ({ action })=>{
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].move(action.editor, {
        unit: "character",
        distance: action.distance
    });
...
}, splitBlockActionImplementation = ({ context, action })=>{
    ...
    if (editor.isTextBlock(focusBlock) && anchorBlockPath[0] === focusBlockPath[0]) {
        ...
        if (!editor.isTextSpan(nextChild) && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].insertNodes(editor, {
            ...
            for (const [child, childPath] of children){
                ...
                for (const mark of marks)schema.decorators.some((decorator)=>decorator.name === mark) || prevNodeSpans.some((prevNodeSpan)=>prevNodeSpan.marks?.includes(mark)) && !newMarkDefKeys.has(mark) && newMarkDefKeys.set(mark, keyGenerator());
...
function createWithEventListeners(editorActor) {
    return function(editor) {
        ...
        const { deleteBackward, deleteForward, insertBreak, insertText, select } = editor;
...
function createWithPatches({ editorActor, patchFunctions, subscriptions }) {
...
function createWithSchemaTypes({ editorActor }) {
    return function(editor) {
        editor.isTextBlock = (value)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isPortableTextTextBlock"])(value) && value._type === editorActor.getSnapshot().context.schema.block.name, editor.isTextSpan = (value)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isPortableTextSpan"])(value) && value._type === editorActor.getSnapshot().context.schema.span.name, editor.isListBlock = (value)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isPortableTextListBlock"])(value) && value._type === editorActor.getSnapshot().context.schema.block.name, editor.isVoid = (element)=>editorActor.getSnapshot().context.schema.block.name !== element._type && (editorActor.getSnapshot().context.schema.blockObjects.map((obj)=>obj.name).includes(element._type) || editorActor.getSnapshot().context.schema.inlineObjects.map((obj)=>obj.name).includes(element._type)), editor.isInline = (element)=>editorActor.getSnapshot().context.schema.inlineObjects.map((obj)=>obj.name).includes(element._type) && "__inline" in element && element.__inline === !0;
        const { normalizeNode } = editor;
...
const withPlugins = (editor, options)=>{
    const e = editor, { editorActor } = options, operationToPatches = createOperationToPatches(editorActor), withObjectKeys = createWithObjectKeys(editorActor), withSchemaTypes = createWithSchemaTypes({
        editorActor
        ...
        delete: (selection, options)=>{
            if (selection) {
                ...
                if (range) {
                    ...
                    options?.mode === "blocks" && (debug$3("Deleting blocks touched by selection"), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$slate$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Transforms"].removeNodes(editor, {
                        at: range,
                        voids: !0,
...
const EditorActorContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])({}), abstractAnnotationBehaviors = [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defineBehavior"])({
        on: "decorator.toggle",
        guard: ({ snapshot, event })=>{
            const manualSelection = event.at ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$util$2e$selection$2d$point$2d$to$2d$block$2d$offset$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["blockOffsetsToSelection"])({
                value: snapshot.context.value,
                offsets: event.at
            }) : null;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defineBehavior"])({
        on: "delete.text",
        guard: ({ snapshot, event })=>{
            const selection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$util$2e$selection$2d$point$2d$to$2d$block$2d$offset$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["blockOffsetsToSelection"])({
                value: snapshot.context.value,
                offsets: event.at
            });
...
function performEvent({ mode, behaviors, event, editor, keyGenerator, schema, getSnapshot, nativeEvent }) {
                ...
                actions.length !== 0 && (behaviorOverwritten = behaviorOverwritten || actions.some((action)=>action.type !== "effect"), withApplyingBehaviorActionSet(editor, ()=>{
                    for (const action of actions){
                        if (action.type === "raise") {
                            performEvent({
                                mode,
                                behaviors: mode === "execute" ? isCustomBehaviorEvent(action.event) ? [
                                    ...behaviors,
                                    ...defaultBehaviors
                                ] : defaultBehaviors : [
                                    ...behaviors,
                        ...
                        if (action.type === "execute") {
                            if (isAbstractBehaviorEvent(action.event) || isCustomBehaviorEvent(action.event)) performEvent({
                                mode: "execute",
...
const editorMachine = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$xstate$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["setup"])({
    ...
    on: {
        ...
        "update value": {
            actions: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$log$2d$0acd9069$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a__as__assign$3e$__["assign"])({
                incomingValue: ({ event })=>event.value
            })
        },
        "update maxBlocks": {
            actions: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$log$2d$0acd9069$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__a__as__assign$3e$__["assign"])({
...
}), PortableTextEditorContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(null), usePortableTextEditor = ()=>{
...
class PortableTextEditor extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Component"] {
   ...
   */ constructor(props){
        if (super(props), props.editor) this.editor = props.editor, this.schemaTypes = this.editor._internal.editorActor.getSnapshot().context.getLegacySchema();
            ...
            const legacySchema = createLegacySchema(props.schemaType.hasOwnProperty("jsonType") ? props.schemaType : compileType(props.schemaType)), schema = legacySchemaToEditorSchema(legacySchema), editorActor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xstate$2f$dist$2f$raise$2d$1db27a82$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__A__as__createActor$3e$__["createActor"])(editorMachine, {
                input: {
                    converters: createCoreConverters(legacySchema),
                    getLegacySchema: ()=>legacySchema,
...
function EditorProvider(props) {
    const editorActor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$xstate$2f$react$2f$dist$2f$xstate$2d$react$2e$development$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useActorRef"])(editorMachine, {
        input: editorConfigToMachineInput(props.initialConfig)
    }), internalEditor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>createInternalEditor(editorActor), [
        editorActor
    ]), portableTextEditor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>new PortableTextEditor({
...
const debug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["debugWithName"])("component:Editable"), PLACEHOLDER_STYLE = {
    ...
    const handleCopy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((event)=>{
        ...
        const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fromSlateValue"])(slateEditor.children, editorActor.getSnapshot().context.schema.block.name, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["KEY_TO_VALUE_ELEMENT"].get(slateEditor)), path = (slateEditor.selection ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$editor$2d$provider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["slateRangeToSelection"])({
            schema: editorActor.getSnapshot().context.schema,
            editor: slateEditor,
            range: slateEditor.selection
    ...
    const handleDragStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((event_8)=>{
        ...
        return editorActor.send({
            ...
            behaviorEvent: {
                type: "select",
                at: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$util$2e$is$2d$selection$2d$collapsed$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isSelectionCollapsed"])(dragSelection) ? dragSelection : {
...
function createMarkdownBehaviors(config) {
    const automaticBlockquoteOnSpace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defineBehavior"])({
        ...
        actions: [
            ()=>[
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["execute"])({
                        type: "insert.text",
                        text: " "
                    })
                ],
        ...
        actions: [
            ({ event })=>[
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["execute"])(event)
                ],
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defineBehavior"])({
        ...
        actions: [
            ...
            (_, { prefixOffsets, suffixOffsets, decorator })=>[
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$portabletext$2f$editor$2f$lib$2f$_chunks$2d$es$2f$behavior$2e$core$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["effect"])(()=>{
                        config.onDecorate({
