...
export type FormRadioButtonGroup = {
  _type: "formRadioButtonGroup";
  label?: string;
  fields?: Array<{
    _key: string;
  } & FormRadioButton>;
...
export type FormRadioButton = {
  _type: "formRadioButton";
  fieldLabel?: string;
  required?: boolean;
  value?: string;
...
export type FormCheckboxGroup = {
  _type: "formCheckboxGroup";
  label?: string;
  required?: boolean;
  fieldHintMessage?: string;
  fields?: Array<{
    _key: string;
  } & FormCheckbox>;
};
...
export type FormModule = {
  ...
  form?: {
    ...
    _type: "reference";
    _weak?: boolean;
    [internalGroqTypeReferenceTo]?: "baseForm";
  };
};
...
export type FormField = {
  ...
  fieldLabel?: string;
  required?: boolean;
  fieldType?: "text" | "email" | "tel" | "number" | "url" | "hidden" | "date" | "time";
...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | Geopoint | Quote | Faq | Faqs | CardSection | TestimonialSlider | ClientList | LogoList | TitleDescription | SplitImage | Hero | Features | Jobs | List | FormType | ThreeColBox | ImageBlock | CareerSubmission | ImageTextSection | TabSection | Job | CareerForm | PageBuilder | Banner | SiteSettings | Page | SanityFileAsset | BlockContent | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | FormGroup | FormRadioButtonGroup | FormRadioButton | FormCheckboxGroup | FormModule | FormEntry | BaseForm | FormTextarea | FormSelect | FormField | FormCheckbox | Color | RgbaColor | HsvaColor | HslaColor | Table | TableRow | MediaTag | Slug;
