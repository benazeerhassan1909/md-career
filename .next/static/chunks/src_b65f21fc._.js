(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_b65f21fc._.js", {
        ...
        "JobApplicationForm.useEffect": ()=>{
            const fetchData = {
                "JobApplicationForm.useEffect.fetchData": async ()=>{
                    try {
                        if (jobId) {
                            result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$lib$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["client"].fetch(JOB_SINGLE_QUERY, {
                                id: jobId
                            });
                            if (result?.formData) {
                                setFormData(result.formData);
                            } else {
                                throw new Error('Form data not found for this job');
                            }
                        } else if (formId) {
                            const pageData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$lib$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["client"].fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$lib$2f$queries$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PAGE_QUERY"]);
                            console.log(pageData);
                            // Find the form block in page builder content
                            const formBlock = pageData?.content?.find({
                                "JobApplicationForm.useEffect.fetchData": (block)=>block._type === 'formType' && block._key === formId
                            }["JobApplicationForm.useEffect.fetchData"]);
                            if (formBlock?.formData) {
                                setFormData(formBlock.formData);
                            } else {
                                throw new Error('Form block not found in page content');
                            }
                        } else {
                            throw new Error('Either jobId or formBlockId must be provided');
                        }
                    } catch (err) {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            (fileError || formErrors[field.name]) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: "jsx-b567c751c15b16d4" + " " + "wpcf7-not-valid-tip file-error mdinc-info mdinc-error",
                                                                children: fileError || formErrors[field.name]
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/Form.tsx",
                                                                lineNumber: 369,
                                                                columnNumber: 57
...
_s(JobApplicationForm, "zyBo+xCAireuHMHeWC+dWQOKA0U=");
...
;
;
function CareerForm({ title, chooseForm }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "wp-block-multidots-multipurpose-block is-block-center mdcareer-about-featured mdinc-section-bottom-margin",
        children: [
            title && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
            ...
            chooseForm && // console.log(chooseForm._ref),
...
//# sourceMappingURL=src_b65f21fc._.js.map