...
const JobApplicationForm = ({ jobId, jobSlug, formId })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            try {
                if (jobId) {
                    result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$lib$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["client"].fetch(JOB_SINGLE_QUERY, {
                        id: jobId
                    });
                    if (result?.formData) {
                    ...
                    __TURBOPACK__imported__module__$5b$externals$5d2f$inspector__$5b$external$5d$__$28$inspector$2c$__cjs$29$__["console"].log(formId);
                    const pageData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$lib$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["client"].fetch(PAGE_QUERY);
                    // Find the form block in page builder content
                    const formBlock = pageData?.content?.find((block)=>block._type === 'formBlock' && block._key === formId);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$inspector__$5b$external$5d$__$28$inspector$2c$__cjs$29$__["console"].error('Submission error:', error);
            setSubmitStatus({
                success: false,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1a8521cc._.js.map